/*
 * Created by JFormDesigner on Sat Jan 03 22:59:39 CET 2026
 */
 ...
 * @author kemal
 */
public class ItsqRootPanel extends JPanel {
    public ItsqRootPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //======== panelControls ========
        {
            ...
            ((GridBagLayout)panelControls.getLayout()).columnWidths = new int[] {0, 119, 0};
            ...
            //---- labelTitle ----
            labelTitle.setText("ITSQ TestSet");
